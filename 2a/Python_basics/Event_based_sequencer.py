...
def instrumentname_noteDuratons_choice():
    ...
    if instrumentChoiceAnswer['instrumentname'] in allSampleDict :
        for i in range(numberSteps):
            # voeg zoveel elementen (als er numberSteps zijn) aan de timestamps array, van kick_event binnen allSampleDict, toe 
            allSampleDict[instrumentChoiceAnswer['instrumentname']]['timestamps'].append(float(input()))
            i += 1

        ...
        while True: 
            if self.playCheck:
                ...
                if self.i < len(self.timestamps):
                    ...
                    self.names_wait_done = self.names[- 1].play()
...
while True:
    ...
    userInput = str(input("Type 'help' for options an explaination\nWhat would you like to do? : "))
    if userInput == 'edit':
        pass
        ...
        print("\t'stop' to stop playing a sample (sample will not be added to MIDI file on 'save'")
